...
//    public int DepartmanId { get; set; } => Bunu EF Core kendisi oluşturur ama kendimiz istersek biz oluşturabiliriz ve EF Core bunu yine algılar ve yeni bir tane kolon oluşturmaz.
...
class ESirketDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Server=localhost, 1433;Database=ESirketDB;User ID=SA;Password=Password1");
    }
