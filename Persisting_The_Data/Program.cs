...
//SaveChanges insert,update ve delete sorgularını oluşturup bir transaction
//eşliğinde veritabanına gonderip execute eden fonksiyondur.
//Eğer oluşturulan sorgulardan herhangi biri başarısız olursa tüm işlemleri geri alır.
...
//SaveChanges fonksiyonu her tetiklendiğinde bir transaction oluşituracağından dolayı
//EF Core ile yapılan her bir işleme özel kullanmaktan kaçınmalıyız!
//Çünkü her işleme özel transaction veritaanı açısından ekstradan maliyet demektir.
//O yüzden mümkün mertebe tüm işlemlerimizi tek bir transaction eşliğinde veritabanına gönderebilmek için
//savechanges'ı aşağıdaki gibi tek seferde kullanmak hem maliyet hem de yönetilebilirlik açısından katkıda bulunmuş olacaktır.
...
public class ETicaretContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        optionsBuilder.UseSqlServer("Server=localhost,1433;" +
            "DataBase=ETicaretDb;User Id=sa;Password=Password1");
    }
}
public class Urun
{
