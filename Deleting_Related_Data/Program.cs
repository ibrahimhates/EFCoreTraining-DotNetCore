...
//Author? author = book.Authors.FirstOrDefault(b => b.Id == 2);
////context.Authors.Remove(author); // Direkt olarak yazarı silmiş olur. Sadece bağ koparmak gerekir. Yazar ile bağ gitmiş olur ama yazarda silinmiş olur.
//book.Authors.Remove(author); // Yazar ile olan ilişki silinmiş olur yazar silinmez.
//await context.SaveChangesAsync();
#endregion
...
class ApplicationDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Server=localhost, 1433;Database=ApplicationDb;User ID=SA;Password=Password1");
    }
